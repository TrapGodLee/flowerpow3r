                        ...
                        <?php add_cart(); ?>
                           ...
                           <form action="details.php?add_cart=<?php echo $product_id; ?>" class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                               <div class="form-group"><!-- form-group Begin -->
                                   <label for="" class="col-md-5 control-label">Product Aantal</label>
                               ...
                               <div class="form-group"><!-- form-group Begin -->
                                   <label class="col-md-5 control-label">Product groote</label>
                                   
                                   <div class="col-md-7"><!-- col-md-7 Begin -->
                                       
                                       <select name="product_size" class="form-control" required oninput="setCustomValidity('')" oninvalid="setCustomValidity('Moet 1 grote kiezen voor het product')"><!-- form-control Begin -->
                                          
                                       <option value="" disabled selected>Selecteer een grote</option>
                               ...
                               <p class="text-center buttons"><button class="btn btn-primary i fa fa-shopping-cart"> Voeg toe aan winkelmand</button></p>
               ...
               <div id="row same-heigh-row"><!-- #row same-heigh-row Begin -->
                   <div class="col-md-3 col-sm-6"><!-- col-md-3 col-sm-6 Begin -->
                       <div class="box same-height headline"><!-- box same-height headline Begin -->
                           <h3 class="text-center">Producten die u misschien leuk vindt</h3>
                       </div><!-- box same-height headline Finish -->
                   </div><!-- col-md-3 col-sm-6 Finish -->

                   <?php

                        /// LIMIT 0,3 geeft een limiet van 3 producten die getoont word en rand() plaats 3 random producten uit de database
