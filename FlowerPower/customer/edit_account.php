...
<h1 align="center">Bewerk Jouw account</h1>
...
<form action="" method="post" enctype="multipart/form-data"><!-- form begin -->
    ...
    <label > Klaten foto: </label>

    <input type="file" name="c_image" class="form-control form-height-custom">

    <img class="img-responsive" src="customer_images/<?php echo $customer_image; ?>" alt="klanten foto">
...
if(isset($_POST['update'])){
    ...
    if($run_customer){
        ...
        echo "<script>alert('Jouw account is bijgewerkt, Om de veranderingen te zien, Log alstublieft opnieuw in')</script>";
